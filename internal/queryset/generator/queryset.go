...
import (
	...
	"github.com/Xwudao/junet/internal/queryset/field"
	"github.com/Xwudao/junet/internal/queryset/methods"
)
...
func GenerateQuerySetsForStructs(types *types.Package, structs map[string]parser.ParsedStruct) (io.Reader, error) {
	...
	var b bytes.Buffer
	err := qsTmpl.Execute(&b, &DBGeneratorData{
